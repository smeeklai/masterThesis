...
class Recognizer(AudioSource):
    def __init__(self):
        ...
        self.dynamic_energy_threshold = False # Enable over time automatic adjusting energy_threshold functionality
        self.dynamic_energy_adjustment_damping = 0.15
        self.dynamic_energy_ratio = 1.5 # Ratio that define the energy_threshold of the system, higher ration means higher threshold
    ...
    def listenMo(self, source, timeout = None):
        ...
        duration_t = 2 # Duration of speech separator (1 = 1 second)
