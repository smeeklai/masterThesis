...
class Recognizer(AudioSource):
    ...
    def listenMo(self, source, timeout = None):
        ...
        try:
            ...
            while True:
                ...
                while True:
                    ...
                    while True:
                        ...
                        if pause_count > pause_buffer_count: # end of the phrase
                            # if self.finalResultReturned is True:
                            break
                            # else:
                                # pause_count = 0
                ...
                # self.finalResultReturned = False
                # print self.finalResultReturned
                finalThread.start()
                ...
                fileName = participantName + '.txt'
                if not os.path.isdir('/home/pi/boss/main_files/output'):
                    os.mkdir('/home/pi/boss/main_files/output')
    ...
    class myThread (threading.Thread):
        ...
        def run(self):
            ...
            # if self.name == "finalThread":
            #     time.sleep(2)
            #     self.parent.finalResultReturned = True
            #     print self.parent.finalResultReturned
                    ...
                    if not self.parent.finalThreadStarted or self.name == "finalThread":
                        ...
                        if self.final():
                            ...
                            if self.name == "finalThread":
                                ...
                                self.parent.sendCaptionToClient(self.parent.get_output_sentence(), self.parent.UDP_IP, self.parent.UDP_PORT)
                            ...
                            # if self.name != "finalThread":
                                ...
                                try:
                                    ...
                                    if len(transcript) > len(self.parent.get_output_sentence()):
                                        self.parent.set_output_sentence(transcript)
                                        # if self.parent.finalResultReturned is True:
                                        self.parent.sendCaptionToClient(self.parent.get_output_sentence(), self.parent.UDP_IP, self.parent.UDP_PORT)
    ...
    def sendCaptionToClient (self, caption, clientIp, clientPort):
        self.server_socket.connect(("192.168.11.10", 80))
